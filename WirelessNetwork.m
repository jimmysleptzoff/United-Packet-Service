classdef WirelessNetwork < handle
    % WirelessNetwork class, version 4.8.  Oct. 16, 2024.
    ...
    properties
        ...
        noise_dBm = -100;     % the noise floor in dBm (set to -Inf to turn off noise)
    ...
    methods
        ...
        function cost_out = ComputeCost( obj )
            ...
            cost_out = num_channels*cost_per_channel + num_bs*cost_per_bs +sum(obj.channel_sets)*spectrum_cost;
        ...
        function MapSINR( obj, varargin )
            ...
            % create a new figure (added in 2024)
            figure;
        ...
        function Recording = MapCity( obj, varargin )
            ...
            figure;  % added this back in 2024
            image( MapImage );
            hold on
